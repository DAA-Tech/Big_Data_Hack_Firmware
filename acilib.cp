#line 1 "C:/Users/Ayodele/Google Drive/DAA STEM Academy/Hack Software/Big_Data_Hack_Firmware/acilib.c"
...
#line 1 "c:/users/public/documents/mikroelektronika/mikroc pro for arm/include/stdint.h"
#line 35 "C:/Users/Ayodele/Google Drive/DAA STEM Academy/Hack Software/Big_Data_Hack_Firmware/acilib.c"
void acil_encode_cmd_set_test_mode(uint8_t *buffer, aci_cmd_params_test_t *p_aci_cmd_params_test)
{
 *(buffer +  0 ) = 2;
 ...
 *(buffer +  2  +  1 ) = (uint8_t)( p_aci_cmd_params_set_app_latency->latency>>8);
 *(buffer +  2  +  0 ) = (uint8_t)( p_aci_cmd_params_set_app_latency->latency);
}
...
void acil_encode_cmd_set_key(uint8_t *buffer, aci_cmd_params_set_key_t *p_aci_cmd_params_set_key)
{
#line 273 "C:/Users/Ayodele/Google Drive/DAA STEM Academy/Hack Software/Big_Data_Hack_Firmware/acilib.c"
 uint8_t len;
...
#line 411 "C:/Users/Ayodele/Google Drive/DAA STEM Academy/Hack Software/Big_Data_Hack_Firmware/acilib.c"
...
char openPipes[8], openClosed[8];

void acil_decode_evt_pipe_status(uint8_t *buffer_in, aci_evt_params_pipe_status_t *p_aci_evt_params_pipe_status)
{
 memcpy((uint8_t *)p_aci_evt_params_pipe_status->pipes_open_bitmap, (buffer_in +  2  +  0 ), 8);
 memcpy(openPipes, (uint8_t *)p_aci_evt_params_pipe_status->pipes_open_bitmap, 8);
 memcpy((uint8_t *)p_aci_evt_params_pipe_status->pipes_closed_bitmap, (buffer_in +  2  +  8 ), 8);
 memcpy(openClosed, (uint8_t *)p_aci_evt_params_pipe_status->pipes_closed_bitmap, 8);
}
