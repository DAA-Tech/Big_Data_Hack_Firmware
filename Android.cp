#line 1 "C:/Users/Ayodele/Google Drive/DAA STEM Academy/Hack Software/Big_Data_Hack_Firmware/Android.c"
...
void OnDataReceived();
#line 8 "C:/Users/Ayodele/Google Drive/DAA STEM Academy/Hack Software/Big_Data_Hack_Firmware/Android.c"
...
static void SetIntValueToBuffer(unsigned int Value){
 ...
 writeBuff[0] = (char)((Value >> 12) & 0xF);
 writeBuff[1] = (char)((Value >> 8) & 0xF);
 writeBuff[2] = (char)((Value >> 4) & 0xF);
 writeBuff[3] = (char)(Value & 0xF);
}
...
void OnDataReceived() {
 ...
 if (readBuff[ 0x04 ] == 0x50) {

 tmp1 = readBuff[ 0x04  + 1];
 GPIOD_ODR = tmp1 & 0xF;
 ...
 delay_ms(20);
 writeBuff[2] = (char)((tmp3 >> 12)& 0xF);
 writeBuff[3] = (char)((tmp3 >> 8)& 0xF);
 writeBuff[4] = (char)((tmp3 >> 4) & 0xF);
 writeBuff[5] = (char)(tmp3 & 0xF);
 txPipe = readBuff[2] + 1;
